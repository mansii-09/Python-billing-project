...
class Invoice_Details(models.Model):
    ...
    Dispatch_through = models.CharField(
        max_length=50
    )
    ...
    Document_note = models.TextField(
        max_length=100
    )
